...
{
    private Dictionary<PoolingType, Pool<PoolableMono>> _poolDictionary
    ...
    {
        Pool<PoolableMono> pool = new Pool<PoolableMono>(
            item.prefab, item.prefab.type, transform, item.poolCount);
